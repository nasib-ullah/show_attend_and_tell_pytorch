...
class DataHandler:
    ...
    def __init__(self,dataset_path, vocabulary):
    ...
    def getDataSets(self):     
        train_dset = COCO14Dataset(self.coco_train,self.voc,transforms=self.data_transform)
        val_dset = COCO14Dataset(self.coco_val,self.voc)
    ...
    def getDataLoaders(self,train_dset,val_dset,test_dset):
        ...
        train_loader=DataLoader(train_dset,batch_size = Config.batch_size, num_workers = 8,shuffle = True,
                            collate_fn = collate_fn, drop_last=True)

        val_loader = DataLoader(val_dset,batch_size = Config.val_batch_size, num_workers = 8,shuffle = False,collate_fn = collate_fn,drop_last=False)
